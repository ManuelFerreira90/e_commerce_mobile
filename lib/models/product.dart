class Product{
  ...
  Product(dynamic id, dynamic title, dynamic description, dynamic price, dynamic discountPercentage, dynamic rating, dynamic stock, dynamic brand, dynamic category, dynamic thumbnail, List<dynamic> tags, List<dynamic> images)
      : _id = id,
        _title = title,
